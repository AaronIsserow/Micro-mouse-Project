...
int main(void)
{
  ...
  while (1)
  {
    ...
    HAL_ADC_Stop(&hadc);
    if(adc_value2 >= 1700) {
      HAL_GPIO_WritePin(LED7_GPIO_Port,LED6_Pin,SET);
    } else if (adc_value2 <= 1500) {
      HAL_GPIO_WritePin(LED7_GPIO_Port,LED6_Pin,RESET);
    }
    ...
    HAL_ADC_Start(&hadc);
    while(HAL_ADC_PollForConversion(&hadc,5)!= HAL_OK);
    adc_value3 = HAL_ADC_GetValue(&hadc);
    HAL_ADC_Stop(&hadc);
    if(adc_value3 >= 1700) {
      HAL_GPIO_WritePin(LED7_GPIO_Port,LED5_Pin,SET);
    } else if (adc_value2 <= 1500){
      HAL_GPIO_WritePin(LED7_GPIO_Port,LED5_Pin,RESET);
    }
